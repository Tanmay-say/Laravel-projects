...
// Include the Practical.php file using an absolute path
require_once __DIR__.'/../../practicals/Practical.php';
...
class PracticalTest extends TestCase {
    ...
    public function testAddAcceptsFloatString(): void {
        $this->assertEquals(Practical::add("1.4", "3.14"), 4.54); // Update the expected result to 4.54
    }
